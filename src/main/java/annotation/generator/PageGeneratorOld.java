...
public class PageGeneratorOld {
    ...
    public PageGeneratorOld collectElements() {
        validateBaseElement();
        ...
        this.collector.setElements(elements);
        return this;
    }
     ...
     */
    public PageGeneratorOld generateMethodsToPage() {
     ...
     */
    //todo очень перегружен и плохо читается, надо переделать
    public PageGeneratorOld collectPages() {
     ...
     */
    private PageGeneratorOld collectBaseScreenFields() {
    ...
    private void generateMethodSpecToPage(VariableElement field, Page page) {
        Element element = this.collector.getElements().stream()
