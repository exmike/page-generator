...
public class SpecsCreator {
    ...
    public Builder getMethodSpecWithoutParams(ExecutableElement method, VariableElement field, Page page,
        ...
        Builder builder = defaultMethodSpecBuilder(method, field, page, mobileElement);
        ...
        return buildStatements(method, field, mobileElement, builder, pageElement, actionStatement);
    }
    ...
    private Builder buildStatements(ExecutableElement method, VariableElement field, MobileElementModel mobileElement,
        ...
        if (pageElement != null
            ...
            builder.addStatement(
                ...
                mobileElement.getType(), Duration.class);
            builder.addStatement(actionStatement, mobileElement.getType());
