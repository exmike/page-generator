...
public class SpecsCreator {
    ...
    public TypeSpec getTypeSpecFromPage(Page page) {
        return TypeSpec.classBuilder(page.getPageName() + "Gen")
            ...
            .addMethod(constructorMethodSpec(page))
            .addAnnotation(AutoGenerated.class)
            .build();
    }

    public MethodSpec constructorMethodSpec(Page page) {
    ...
    public MethodSpec generateScreenMethods(
        ...
        return MethodSpec.methodBuilder(Utils.uncapitalize(simpleName))
            .addModifiers(Modifier.PUBLIC)
            .returns(elementType)
            .addStatement("return new $T()", elementType)
            .build();
    }
